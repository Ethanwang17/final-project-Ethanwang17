...
ui <- navbarPage("Final Deliverable",
                 ...
                 tabPanel("Introduction",
                          ...
                          h3("Health is an essential part of every being and it's important that we humans know how to keep ourselves healthy as good health is critical for one's happieness and well-being. Health is imporatnt as it is essential for keeping our bodies alive and working. This projects goal is to better understand how"),
                          h1("Page Description"),
                          h3("The chart 1 tab is an interactive slider that allows you to filter a range of age groups that shows the resting blood pressure for that rage af ages. This tab explains how the age of a person effects the resting blood pressure of the human body?" ,  style = "color: Orange"),
                          h3("The chart 2 tab allows the user to input their age and sex and will return the average resting blood pressure, cholesterol, and max heart rate between those who do and don't have a heart diesease. This tab explains how does the average resting blood pressure, cholesterol, and max heart rate differ between those who do and don't have a heart disease?" ,  style = "color: Orange"),
                          h3("The chart 3 tab allows the user to choose the pain type and what they want to compare it to and will be shown a bar chart of their selection. This tabe explains how the different types of chest pain (ASY, ATA, NAP, TA) effect the average cholesterol in a person?" ,  style = "color: Orange")
                          ),
                 ...
                 tabPanel(
                   ...
                   sidebarLayout(
                     ...
                     mainPanel(
                       ...
                       p(),
                       plotlyOutput("plot_2"),
                       h3("This is a vertical box and whiskers plot that shows the distriubtion 
                       ...
                       h3("For cholesterol levels and resting heart rate, males tend to have a slighlty higher median than females. 
                 ...
                 tabPanel(
                   ...
                   sidebarLayout(
                     ...
                     mainPanel(
                       plotlyOutput("plot_3"),
                       h1("[ASY = Asymptomatic, ATA = Atypical Non-Anginal, NAP = Non-Anginal, TA = Typical Angina] This bar graph compares the different types of heart pain to the variable that the user selects." ,  style = "color: Pink"),
                       h1(),
                       h1("Analyzed..."),
                       h3("The findings show that the different types of heart pain have relatively similar average cholesterol 
